...
/* 
/// @brief Será informado qual dos botões será apertado e a quantidade de vezes que isso será
feito, ou seja, será retirada a última forma que foi colocada no carregador selecionado, e 
essa será postana posição de disparo. Caso já tenha alguma forma em posição de disparo, a 
forma que já estava naquela posição será inserida no outro carregador, liberando a posição de
disparo.*/
...
/// @brief Dispara a forma que estava em posição na arena e deixa sem nenhuma forma essa posição de disparo.
